...
import algorithms.ClosureAutomatonsGenerator;
...
public class AutomatonClosureGenerationInputController {
    ...
    private void setupTaskButton(Button button) {
        button.setOnAction(event -> {
            ...
            closureAutomatonsGenerator.generateClosureAutomatons();
            try {
                closureAutomatonsGenerator.createTasksPdfFile();
                closureAutomatonsGenerator.createAnswersPdfFile();
            } catch (IOException e) {
