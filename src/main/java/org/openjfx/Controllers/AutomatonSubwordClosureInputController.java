...
public class AutomatonSubwordClosureInputController extends AutomatonInputController {
    @FXML
    ...
    protected Button getCreateAutomatonButton(TextField startVertexTextField, TextField finalVerticesTextField,
        ...
        button.setOnAction(event2 -> {
            ...
            try {
                ...
                automatonList.add(Closures.subwordClosure(resAutomaton));
            ...
            Loader.loadFxml("/taskEleven.fxml", true);
        });
        return button;
    }
