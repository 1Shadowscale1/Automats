...
public class AutomatonSuffixClosureInputController extends AutomatonInputController {
    @FXML
    ...
    protected Button getCreateAutomatonButton(TextField startVertexTextField, TextField finalVerticesTextField,
        ...
        button.setOnAction(event2 -> {
            ...
            try {
                ...
                automatonList.add(Closures.suffixClosure(resAutomaton));
            ...
            Loader.loadFxml("/taskTen.fxml", true);
        });
        return button;
    }
